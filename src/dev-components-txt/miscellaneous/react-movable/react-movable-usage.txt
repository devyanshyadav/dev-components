  ...
  return (
    <div className="flex flex-col gap-2 items-center">
      <div className="text-xs space-x-1 m-2">
        ...
        {items.map((e, i) => (
          <span
            className="bg-accentNeon/30 text-nowrap p-1 px-2 rounded-full"
            key={i}
          >
            {e}
          </span>
      ...
      <div className="w-60 h-auto px-2 rounded-lg border border-accentNeon/20 bg-rtlLight dark:bg-rtlDark">
