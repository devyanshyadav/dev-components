        ...
        createPortal(
          ...
          >
            <motion.section
              ...
              className="relative w-[90vw] flex border border-cyan-500/30 flex-col md:w-[40vw] min-h-60 rounded-xl shadow-md bg-slate-100 dark:bg-slate-900 overflow-hidden"
            >
