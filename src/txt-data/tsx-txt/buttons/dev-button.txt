...
const DevButton = ({
  ...
  const buttonVariants = {
    ...
    light:
      "hover:bg-cyan-500/30 text-cyan-500 font-semibold border-2 border-cyan-500",
    flat: "border-cyan-500/5 bg-cyan-500/20 text-cyan-500 font-semibold backdrop-blur-sm ",
    ghost:
      "text-cyan-500 hover:bg-cyan-500 hover:text-white font-semibold border-2 border-cyan-500",
  };
