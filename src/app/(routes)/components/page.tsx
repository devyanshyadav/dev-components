...
const page = () => {
  return (
    <section className=" w-full grid gap-4 place-items-center p-1 md:max-w-2xl mx-auto">
     ...
     <p className="opacity-80 text-pretty text-sm">Discover Dev Components, a unique platform offering a wide range of fully customizable and functional React components. Enhance your web development experience with our ready-to-use, highly flexible UI elements.</p>
     </div>
