  ...
  return (
    ...
    >
      <Slider.Track className="relative grow rounded-full h-full bg-ACCENT/40 overflow-hidden">
        <Slider.Thumb
          className="block h-5 focus:outline-none active:border-4 aspect-square border-2 shadow-[-1008px_0_0_1000px] shadow-ACCENT  bg-ACCENT transition-all rounded-full cursor-pointer  dark:border-LIGHT border-DARK"
          aria-label="Slider"
        />
      </Slider.Track>
    </Slider.Root>
