...
const DevSelectV3 = ({
  ...
  return (
    <Select.Root {...props}>
      <Select.Trigger className="flex text-nowrap outline-0 space-x-2 items-center justify-between w-full p-1.5 px-3 rounded-md bg-LIGHT dark:bg-DARK border focus:ring-[3px] ring-ACCENT/50 transition-all border-ACCENT">
