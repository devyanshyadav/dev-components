...
function DialogModal({
    ...
    return (
        <>
            ...
            <dialog
                className="w-[90vw] border border-cyan-500/30 backdrop:bg-black/50 overflow-hidden relative flex-none bg-white dark:bg-slate-900  md:w-[40vw] min-h-60 rounded-xl"
                ref={ref}
            >
